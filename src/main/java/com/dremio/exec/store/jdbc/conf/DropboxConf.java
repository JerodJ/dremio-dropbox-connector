...
@SourceType(value = "DropboxARP", label = "Dropbox",uiConfig = "dropbox-layout.json")
public class DropboxConf extends AbstractArpConf<DropboxConf> {
  private static final String ARP_FILENAME = "arp/implementation/dropbox-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.dropbox.DropboxDriver";
